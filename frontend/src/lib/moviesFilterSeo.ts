...
const SECTION_SEO: Record<MoviesSectionSegment, MoviesSectionSeo> = {
  ...
  week: {
    title: "Ταινίες εβδομάδας - πρόγραμμα σινεμά Αθήνα",
    h1: "Εβδομάδα κινηματογράφου",
    subtitle: `Προβολές ${formatUpcomingCinemaWeekRange()} · νέα εβδομάδα κινηματογράφου`,
    description: `Τι παίζει την εβδομάδα κινηματογράφου (${formatUpcomingCinemaWeekRange()}): ταινίες, ώρες και σινεμά σε Αθήνα, Θεσσαλονίκη και Ελλάδα.`,
    intro:
...
> = {
  athens: {
    title: "Ταινίες Αθήνα σήμερα - σινεμά & ώρες",
    h1: "Ταινίες στην Αθήνα",
    description:
      "Τι παίζει στα σινεμά της Αθήνας: πρόγραμμα, ώρες προβολών, θερινά και αφίσες - διάλεξε ταινία και χώρο.",
  },
  thessaloniki: {
    title: "Ταινίες Θεσσαλονίκη - πρόγραμμα & ώρες",
    h1: "Ταινίες στη Θεσσαλονίκη",
    description:
      "Τι παίζει στη Θεσσαλονίκη: σινεμά, ώρες προβολών και αφίσες - ενημερωμένο πρόγραμμα ταινιών.",
  },
  other: {
    title: "Ταινίες στην Ελλάδα - πρόγραμμα σινεμά",
    h1: "Ταινίες στην υπόλοιπη Ελλάδα",
    description:
      "Πρόγραμμα ταινιών σε σινεμά εκτός Αθήνας και Θεσσαλονίκης - ώρες, χώροι και αφίσες.",
  },
};
