...
export const HOME_HERO_CRITICAL_CSS =
  "#home-hero-slot{position:relative;width:100%;min-height:380px;background:#13143e;overflow:hidden;contain:layout style paint}" +
  ...
  "@media(min-width:768px){.home-main-overlap{margin-top:-580px;padding-top:4rem}}";
