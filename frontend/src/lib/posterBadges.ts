...
export const POSTER_BADGE_CORNER_TOP_LEFT = "absolute left-2 top-2 z-10";
export const POSTER_BADGE_CORNER_TOP_RIGHT = "absolute right-2 top-2 z-10 flex flex-col items-end gap-1";
