...
export const staticPageSeo = {
  ...
  venues: {
    title: "Σινεμά Αθήνας — χώροι προβολής ανά περιοχή",
    description:
      "Σινεμά και θερινά στην Αθήνα: διευθύνσεις, χάρτης και πρόγραμμα ταινιών ανά περιοχή (Κέντρο, προάστια, Πειραιάς).",
    path: "/venues",
  },
  dining: {
    title: "Φαγητό",
