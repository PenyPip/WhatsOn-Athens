...
export const staticPageSeo = {
  ...
  venues: {
    title: "Σινεμά — χώροι προβολής στην Ελλάδα",
    description:
      "Σινεμά και θερινά σινεμά: διευθύνσεις, χάρτης και πλήρες πρόγραμμα ταινιών ανά χώρο. Για θέατρο δες τις παραστάσεις.",
    path: "/venues",
  },
  dining: {
    title: "Φαγητό",
