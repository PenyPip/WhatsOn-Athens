...
const CRITICAL_CSS =
  ...
  "#home-static-lcp{position:fixed;inset:0 auto auto 0;z-index:1;width:100%;overflow:hidden;background:#111;height:min(75vh,520px);contain:layout style paint}" +
