    ...
    <div className="min-h-screen pt-36 pb-20 md:pb-8">
      ...
      <div className="container max-w-2xl">
        <div className="card-elevated animate-fade-in-up p-8 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-6 rounded-md border border-amber-500/25 bg-amber-500/[0.08] px-3 py-2">
            Οι συνδέσεις με Google, Apple και Microsoft βρίσκονται σε εξέλιξη· σύντομα διαθέσιμες.
          </p>
          ...
          <div className="space-y-3 max-w-xs mx-auto">
            <button
              type="button"
              disabled
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded border border-border text-sm font-medium opacity-60 cursor-not-allowed"
            >
