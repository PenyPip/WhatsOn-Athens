...
module.exports = {
  ...
  /**
   * Πέμπτη ~09:00 / 13:00 / 17:00 Europe/Athens (ώρα server UTC: 06/10/14 το καλοκαίρι).
   * Ξανατρέχει μέχρι να γεμίσουν τα εκκρεμή — το πρόγραμμα συχνά ανεβαίνει σταδιακά.
   * Μετά το βασικό batch: deferred σινεμά (default #2) μόνα τους με μεγαλύτερο timeout.
   */
  athinoramaPendingSyncThursday: {
    ...
    options: {
      // Πέμπτη 06:00, 10:00, 14:00 UTC ≈ 09:00 / 13:00 / 17:00 Αθήνα (θερινή ώρα)
      rule: '0 6,10,14 * * 4',
    },
  },
