...
const config = {
  ...
  translations: {
    en: {
      ...
      'content-manager.components.home.hero-banner.theater_show': 'Σχετική παράσταση',
      'content-manager.components.home.hero-banner.event': 'Σχετικό event',
      'content-manager.content-types.api::homepage.homepage.hero_banners': 'Banners hero',
      'content-manager.content-types.api::homepage.homepage.layout_sections': 'Μπλοκ αρχικής',
